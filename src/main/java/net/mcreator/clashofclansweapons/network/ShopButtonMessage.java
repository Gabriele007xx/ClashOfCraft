...
import net.mcreator.clashofclansweapons.procedures.ResourcesButtonProcedure;
import net.mcreator.clashofclansweapons.procedures.DefencesButtonProcedure;
...
public class ShopButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			ResourcesButtonProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {

			DefencesButtonProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		ClashofclansweaponsMod.addNetworkMessage(ShopButtonMessage.class, ShopButtonMessage::buffer, ShopButtonMessage::new,
				ShopButtonMessage::handler);
	}
}
