...
public class ClashofclansweaponsModItems {
	...
	public static final RegistryObject<Item> BARBARIAN_SWORD_LV_3 = REGISTRY.register("barbarian_sword_lv_3", () -> new BarbarianSwordLv3Item());
	public static final RegistryObject<Item> BARBARIAN_SWORD_LV_4 = REGISTRY.register("barbarian_sword_lv_4", () -> new BarbarianSwordLv4Item());
	public static final RegistryObject<Item> BARBARIAN_SWORD_LV_5 = REGISTRY.register("barbarian_sword_lv_5", () -> new BarbarianSwordLv5Item());
	public static final RegistryObject<Item> BARBARIAN_SWORD_LV_6 = REGISTRY.register("barbarian_sword_lv_6", () -> new BarbarianSwordLv6Item());
	public static final RegistryObject<Item> BARBARIAN_SWORD_LV_7 = REGISTRY.register("barbarian_sword_lv_7", () -> new BarbarianSwordLv7Item());
	public static final RegistryObject<Item> PEKKASWORD_LV_1 = REGISTRY.register("pekkasword_lv_1", () -> new PekkaswordLv1Item());
	public static final RegistryObject<Item> PEKKASWORD_LV_2 = REGISTRY.register("pekkasword_lv_2", () -> new PekkaswordLv2Item());
	public static final RegistryObject<Item> PEKKASWORD_LV_3 = REGISTRY.register("pekkasword_lv_3", () -> new PekkaswordLv3Item());
	public static final RegistryObject<Item> PEKKASWORD_LV_4 = REGISTRY.register("pekkasword_lv_4", () -> new PekkaswordLv4Item());
	public static final RegistryObject<Item> WITCH_STICK_SKULL = REGISTRY.register("witch_stick_skull", () -> new WitchStickSkullItem());
	...
	public static final RegistryObject<Item> ELIXIR = REGISTRY.register("elixir", () -> new ElixirItem());
	public static final RegistryObject<Item> DARK_ELIXIR = REGISTRY.register("dark_elixir", () -> new DarkElixirItem());
	public static final RegistryObject<Item> BUILDER_ELIXIR = REGISTRY.register("builder_elixir", () -> new BuilderElixirItem());
	public static final RegistryObject<Item> GEAR = REGISTRY.register("gear", () -> new GearItem());
	public static final RegistryObject<Item> PUMP = REGISTRY.register("pump", () -> new PumpItem());
	public static final RegistryObject<Item> TUBE = REGISTRY.register("tube", () -> new TubeItem());
	...
	public static final RegistryObject<Item> SUPER_POTION = REGISTRY.register("super_potion", () -> new SuperPotionItem());
	public static final RegistryObject<Item> BOOK_OF_BUILDING = REGISTRY.register("book_of_building", () -> new BookOfBuildingItem());
	public static final RegistryObject<Item> HAMMER_OF_BUILDING = REGISTRY.register("hammer_of_building", () -> new HammerOfBuildingItem());
	public static final RegistryObject<Item> HAMMER_OF_HEROES = REGISTRY.register("hammer_of_heroes", () -> new HammerOfHeroesItem());
	public static final RegistryObject<Item> PEKKALEVEL_1 = REGISTRY.register("pekkalevel_1_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.PEKKALEVEL_1, -8700717, -442881,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> PEKKALEVEL_2 = REGISTRY.register("pekkalevel_2_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.PEKKALEVEL_2, -13434727, -10066177,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> XBOW_LV_1 = REGISTRY.register("xbow_lv_1_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.XBOW_LV_1, -10066330, -65332,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> MORTAR_LV_10_E = REGISTRY.register("mortar_lv_10_e_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.MORTAR_LV_10_E, -10066330, -52429,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> ARCHER_QUEEN = REGISTRY.register("archer_queen_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.ARCHER_QUEEN, -10027264, -10092442,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> EAGLE_ARTILLERY = REGISTRY.register("eagle_artillery_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.EAGLE_ARTILLERY, -1, -6710887,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> B_MACHINE = REGISTRY.register("b_machine_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.B_MACHINE, -10079488, -10066330,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> BUILDER = REGISTRY.register("builder_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.BUILDER, -6724096, -205, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> SCATTERSHOT = REGISTRY.register("scattershot_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.SCATTERSHOT, -16737844, -13421773,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> HOG_RIDER = REGISTRY.register("hog_rider_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.HOG_RIDER, -10079488, -52225,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> INFERNO_TOWER = REGISTRY.register("inferno_tower_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.INFERNO_TOWER, -3407821, -16777216,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> WIZARD = REGISTRY.register("wizard_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.WIZARD, -16763905, -1, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> CANNON_LV_1 = REGISTRY.register("cannon_lv_1_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.CANNON_LV_1, -10066330, -6710887,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> UNICORN = REGISTRY.register("unicorn_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.UNICORN, -1, -256, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> LASSI = REGISTRY.register("lassi_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.LASSI, -13434778, -6750055,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> WITCH_COC = REGISTRY.register("witch_coc_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.WITCH_COC, -10092442, -16777063,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> NIGHT_WITCH = REGISTRY.register("night_witch_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.NIGHT_WITCH, -16777216, -16777063,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> GIANT_COC = REGISTRY.register("giant_coc_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.GIANT_COC, -6724096, -13108,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> DRAGON = REGISTRY.register("dragon_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.DRAGON, -10040320, -52480,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> ELECTRO_OWL = REGISTRY.register("electro_owl_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.ELECTRO_OWL, -16777012, -1,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> BATTLE_MACHINE_LV_10 = REGISTRY.register("battle_machine_lv_10_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.BATTLE_MACHINE_LV_10, -10066432, -6710887,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> BATTLE_MACHINE_LV_20 = REGISTRY.register("battle_machine_lv_20_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.BATTLE_MACHINE_LV_20, -10066432, -256,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> SUPER_WITCH = REGISTRY.register("super_witch_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.SUPER_WITCH, -16777063, -6710887,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> CANNON_CART = REGISTRY.register("cannon_cart_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.CANNON_CART, -13421773, -10066330,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> AIR_DEFENCE = REGISTRY.register("air_defence_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.AIR_DEFENCE, -65485, -10079488,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> BATTLE_BUILDER_HUT_LEVELTWO = REGISTRY.register("battle_builder_hut_leveltwo_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.BATTLE_BUILDER_HUT_LEVELTWO, -10079488, -13369600,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> VALKIRYE = REGISTRY.register("valkirye_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.VALKIRYE, -26317, -6724096,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> MORTAR_LV_14 = REGISTRY.register("mortar_lv_14_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.MORTAR_LV_14, -16777216, -256,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> MORTAR_LV_1_ENTITY = REGISTRY.register("mortar_lv_1_entity_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.MORTAR_LV_1_ENTITY, -13421773, -6724096,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> GIANT_ITEM = REGISTRY.register("giant_item", () -> new GiantItemItem());
	public static final RegistryObject<Item> WIZARD_ITEM = REGISTRY.register("wizard_item", () -> new WizardItemItem());
	public static final RegistryObject<Item> PEKKA_LV_1_ITEM = REGISTRY.register("pekka_lv_1_item", () -> new PekkaLv1ItemItem());
	public static final RegistryObject<Item> PEKKA_LV_2_ITEM = REGISTRY.register("pekka_lv_2_item", () -> new PekkaLv2ItemItem());
	public static final RegistryObject<Item> DRAGON_ITEM = REGISTRY.register("dragon_item", () -> new DragonItemItem());
	public static final RegistryObject<Item> HOG_RIDER_ITEM = REGISTRY.register("hog_rider_item", () -> new HogRiderItemItem());
	public static final RegistryObject<Item> VALKYRIE_ITEM = REGISTRY.register("valkyrie_item", () -> new ValkyrieItemItem());
	public static final RegistryObject<Item> WITCH_ITEM = REGISTRY.register("witch_item", () -> new WitchItemItem());
	public static final RegistryObject<Item> SUPER_WITCH_ITEM = REGISTRY.register("super_witch_item", () -> new SuperWitchItemItem());
	public static final RegistryObject<Item> BATTLE_MACHINE_ITEM = REGISTRY.register("battle_machine_item", () -> new BattleMachineItemItem());
	public static final RegistryObject<Item> BATTLE_MACHINE_LV_10_ITEM = REGISTRY.register("battle_machine_lv_10_item",
			() -> new BattleMachineLv10ItemItem());
	public static final RegistryObject<Item> BATTLE_MACHINE_LV_20_ITEM = REGISTRY.register("battle_machine_lv_20_item",
			() -> new BattleMachineLv20ItemItem());
	public static final RegistryObject<Item> CANNON_CART_ITEM = REGISTRY.register("cannon_cart_item", () -> new CannonCartItemItem());
	public static final RegistryObject<Item> NIGHT_WITCH_ITEM = REGISTRY.register("night_witch_item", () -> new NightWitchItemItem());
	public static final RegistryObject<Item> WALL_WRECKER_ITEM = REGISTRY.register("wall_wrecker_item", () -> new WallWreckerItemItem());
	public static final RegistryObject<Item> SIEGE_BARRACKS_ITEM = REGISTRY.register("siege_barracks_item", () -> new SiegeBarracksItemItem());
	public static final RegistryObject<Item> ITEM_F = REGISTRY.register("item_f", () -> new ItemFItem());
	public static final RegistryObject<Item> DOUBLE_CANNON_SHOTGUN = REGISTRY.register("double_cannon_shotgun", () -> new DoubleCannonShotgunItem());
	public static final RegistryObject<Item> ELIXIR_ARMOR_HELMET = REGISTRY.register("elixir_armor_helmet", () -> new ElixiraArmorItem.Helmet());
	public static final RegistryObject<Item> ELIXIR_ARMOR_CHESTPLATE = REGISTRY.register("elixir_armor_chestplate",
			() -> new ElixiraArmorItem.Chestplate());
	public static final RegistryObject<Item> ELIXIR_ARMOR_LEGGINGS = REGISTRY.register("elixir_armor_leggings",
			() -> new ElixiraArmorItem.Leggings());
	public static final RegistryObject<Item> ELIXIR_ARMOR_BOOTS = REGISTRY.register("elixir_armor_boots", () -> new ElixiraArmorItem.Boots());
	...
	public static final RegistryObject<Item> BATTLE_BUILDER_HUT_LV_2 = REGISTRY.register("battle_builder_hut_lv_2",
			() -> new BattleBuilderHutLv2Item());
	public static final RegistryObject<Item> ELIXIR_COLLECTOR_LEVEL_1 = block(ClashofclansweaponsModBlocks.ELIXIR_COLLECTOR_LEVEL_1,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> ELIXIR_COLLECTOR_LEVEL_2 = block(ClashofclansweaponsModBlocks.ELIXIR_COLLECTOR_LEVEL_2,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> ELIXIR_COLLECTOR_LEVEL_3 = block(ClashofclansweaponsModBlocks.ELIXIR_COLLECTOR_LEVEL_3,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> ELIXIR_COLLECTOR_LEVEL_4 = block(ClashofclansweaponsModBlocks.ELIXIR_COLLECTOR_LEVEL_4,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> ELIXIR_COLLECTOR_LEVEL_5 = block(ClashofclansweaponsModBlocks.ELIXIR_COLLECTOR_LEVEL_5,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> DARK_ELIXIR_DRILL_LV_1 = block(ClashofclansweaponsModBlocks.DARK_ELIXIR_DRILL_LV_1,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> DARK_ELIXIR_DRILL_LV_2 = block(ClashofclansweaponsModBlocks.DARK_ELIXIR_DRILL_LV_2,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> DARK_ELIXIR_DRILL_LV_3 = block(ClashofclansweaponsModBlocks.DARK_ELIXIR_DRILL_LV_3,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> DARK_ELIXIR_STORAGE_LEVEL_6 = block(ClashofclansweaponsModBlocks.DARK_ELIXIR_STORAGE_LEVEL_6,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> DARK_ELIXIR_STORAGE_LV_7 = block(ClashofclansweaponsModBlocks.DARK_ELIXIR_STORAGE_LV_7,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> DARK_ELIXIR_STORAGE_LV_8 = block(ClashofclansweaponsModBlocks.DARK_ELIXIR_STORAGE_LV_8,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> DARK_ELIXIR_STORAGE_LV_9 = block(ClashofclansweaponsModBlocks.DARK_ELIXIR_STORAGE_LV_9,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> GOLD_MINE_LV_1 = block(ClashofclansweaponsModBlocks.GOLD_MINE_LV_1,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> GOLD_MINE_LV_2 = block(ClashofclansweaponsModBlocks.GOLD_MINE_LV_2,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	...
	public static final RegistryObject<Item> DARK_BARRACKS = block(ClashofclansweaponsModBlocks.DARK_BARRACKS,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	...
	public static final RegistryObject<Item> SPELL_FACTORY = block(ClashofclansweaponsModBlocks.SPELL_FACTORY,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> GRAND_WARDEN = block(ClashofclansweaponsModBlocks.GRAND_WARDEN,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> CANNON_LV_1_ITEM = REGISTRY.register("cannon_lv_1_item", () -> new CannonLv1ItemItem());
	public static final RegistryObject<Item> MORTAR_LV_1_ITEM = REGISTRY.register("mortar_lv_1_item", () -> new MortarLv1ItemItem());
	public static final RegistryObject<Item> MORTAR_LV_10_ITEM = REGISTRY.register("mortar_lv_10_item", () -> new MortarLv10ItemItem());
	public static final RegistryObject<Item> MORTAR_LV_14_ITEM = REGISTRY.register("mortar_lv_14_item", () -> new MortarLv14ItemItem());
	public static final RegistryObject<Item> AIR_DEFENCE_ITEM = REGISTRY.register("air_defence_item", () -> new AirDefenceItemItem());
	public static final RegistryObject<Item> X_BOW_LV_1_ITEM = REGISTRY.register("x_bow_lv_1_item", () -> new XBowLv1ItemItem());
	public static final RegistryObject<Item> INFERNO_TOWER_ITEM = REGISTRY.register("inferno_tower_item", () -> new InfernoTowerItemItem());
	public static final RegistryObject<Item> EAGLE_ARTILLERY_ITEM = REGISTRY.register("eagle_artillery_item", () -> new EagleArtilleryItemItem());
	public static final RegistryObject<Item> SCATTERSHOT_LV_1_ITEM = REGISTRY.register("scattershot_lv_1_item", () -> new ScattershotLv1ItemItem());
	public static final RegistryObject<Item> ARCHERQUEENALTAR = block(ClashofclansweaponsModBlocks.ARCHERQUEENALTAR,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> SUPER_BARREL = block(ClashofclansweaponsModBlocks.SUPER_BARREL,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> CLAN_CASTLE_LV_1 = block(ClashofclansweaponsModBlocks.CLAN_CASTLE_LV_1,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> CLAN_CASTLE_LEVEL_2 = block(ClashofclansweaponsModBlocks.CLAN_CASTLE_LEVEL_2,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> ELIXIR_STORAGE_LV_1 = block(ClashofclansweaponsModBlocks.ELIXIR_STORAGE_LV_1,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> ELIXIR_STORAGE_LV_2 = block(ClashofclansweaponsModBlocks.ELIXIR_STORAGE_LV_2,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> ELIXIR_STORAGE_LIV_3 = block(ClashofclansweaponsModBlocks.ELIXIR_STORAGE_LIV_3,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	...
	public static final RegistryObject<Item> TOWN_HALL_LV_1 = block(ClashofclansweaponsModBlocks.TOWN_HALL_LV_1,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> TOWN_HALL_LV_2 = block(ClashofclansweaponsModBlocks.TOWN_HALL_LV_2,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> TOWN_HALL_LE_3 = block(ClashofclansweaponsModBlocks.TOWN_HALL_LE_3,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> TOWN_HALL_LV_4 = block(ClashofclansweaponsModBlocks.TOWN_HALL_LV_4,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> TOWN_HALL_LV_5 = block(ClashofclansweaponsModBlocks.TOWN_HALL_LV_5,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> TH_121_OBJECT = REGISTRY.register("th_121_object", () -> new TH121ObjectItem());
	public static final RegistryObject<Item> BB_ELIXIRCOLLECTOR = block(ClashofclansweaponsModBlocks.BB_ELIXIRCOLLECTOR,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> GRAND_WARDEN_LV_5 = block(ClashofclansweaponsModBlocks.GRAND_WARDEN_LV_5,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> COC_GRASS = block(ClashofclansweaponsModBlocks.COC_GRASS, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> GRASS_BLOCK_BUILDER_BASE = block(ClashofclansweaponsModBlocks.GRASS_BLOCK_BUILDER_BASE,
			CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> ELIXIRORE = block(ClashofclansweaponsModBlocks.ELIXIRORE, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> DEORE = block(ClashofclansweaponsModBlocks.DEORE, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> BUILDER_ELIXIR_ORE = block(ClashofclansweaponsModBlocks.BUILDER_ELIXIR_ORE,
			CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> LIGHTING_SPELL = REGISTRY.register("lighting_spell", () -> new LightingSpellItem());
	...
	public static final RegistryObject<Item> ELXIIR_STORAGE_UPGRADE = block(ClashofclansweaponsModBlocks.ELXIIR_STORAGE_UPGRADE,
			ClashofclansweaponsModTabs.TAB_UPGRADERS);
	...
	public static final RegistryObject<Item> TOWN_HALL_UPGRADER = block(ClashofclansweaponsModBlocks.TOWN_HALL_UPGRADER,
			ClashofclansweaponsModTabs.TAB_UPGRADERS);
	public static final RegistryObject<Item> GOLD_MINE_UP = block(ClashofclansweaponsModBlocks.GOLD_MINE_UP,
			ClashofclansweaponsModTabs.TAB_UPGRADERS);
	public static final RegistryObject<Item> DARK_ELIXIR_DRILL_UPGRADER = block(ClashofclansweaponsModBlocks.DARK_ELIXIR_DRILL_UPGRADER,
			ClashofclansweaponsModTabs.TAB_UPGRADERS);
	public static final RegistryObject<Item> ICSBOW = REGISTRY.register("icsbow", () -> new XbowItem());
	public static final RegistryObject<Item> SCATTERSHOT_LV_1 = REGISTRY.register("scattershot_lv_1", () -> new ScattershotLv1Item());
	public static final RegistryObject<Item> MORTAR_LV_1 = REGISTRY.register("mortar_lv_1", () -> new MortarLv1Item());
	public static final RegistryObject<Item> LAVA_LAUNCHER_LV_1 = REGISTRY.register("lava_launcher_lv_1", () -> new LavaLauncherLv1Item());
	public static final RegistryObject<Item> MORTAR_LV_5 = REGISTRY.register("mortar_lv_5", () -> new MortarLv5Item());
	public static final RegistryObject<Item> MORTAR_LV_8 = REGISTRY.register("mortar_lv_8", () -> new MortarLv8Item());
	public static final RegistryObject<Item> MORTAR_LV_10 = REGISTRY.register("mortar_lv_10", () -> new MortarLv10Item());
	public static final RegistryObject<Item> MORTAR_LV_12 = REGISTRY.register("mortar_lv_12", () -> new MortarLv12Item());
	public static final RegistryObject<Item> MORTAR_LV_13 = REGISTRY.register("mortar_lv_13", () -> new MortarLv13Item());
	public static final RegistryObject<Item> EAP = REGISTRY.register("eap", () -> new EAPItem());
	public static final RegistryObject<Item> EA = REGISTRY.register("ea", () -> new EaItem());
	...
	public static final RegistryObject<Item> INFERNO_TOWER_LV_1_ITEM = REGISTRY.register("inferno_tower_lv_1_item",
			() -> new InfernoTowerLv1ItemItem());
	public static final RegistryObject<Item> WIZARD_PROJECTILE = REGISTRY.register("wizard_projectile", () -> new WizardProjectileItem());
	public static final RegistryObject<Item> CANNON_LV_1_PROJECTILE = REGISTRY.register("cannon_lv_1_projectile",
			() -> new CannonLv1ProjectileItem());
	public static final RegistryObject<Item> UNICORN_HEAL = REGISTRY.register("unicorn_heal", () -> new UnicornHealItem());
	public static final RegistryObject<Item> HEALING_PULSE = REGISTRY.register("healing_pulse", () -> new HealingPulseItem());
	public static final RegistryObject<Item> WITCH_PROJECTILE_DA = REGISTRY.register("witch_projectile_da", () -> new WitchProjectileDaItem());
	public static final RegistryObject<Item> DRAGON_WEAPON = REGISTRY.register("dragon_weapon", () -> new DragonWeaponItem());
	public static final RegistryObject<Item> ELECTRO_OWL_RAGED = REGISTRY.register("electro_owl_raged", () -> new ElectroOwlRAGEDItem());
	...
	public static final RegistryObject<Item> CANNON_CART_LV_1_RANGED_ITEM = REGISTRY.register("cannon_cart_lv_1_ranged_item",
			() -> new CannonCartLv1RangedItemItem());
	...
	public static final RegistryObject<Item> AIRDEFENCE_RANGED = REGISTRY.register("airdefence_ranged", () -> new AirdefenceRangedItem());
	public static final RegistryObject<Item> BATTLE_BUILDER_HUT_PROJECTILE = REGISTRY.register("battle_builder_hut_projectile",
			() -> new BattleBuilderHutProjectileItem());
	public static final RegistryObject<Item> BATTLE_BUILDER_HUT_RAGED = REGISTRY.register("battle_builder_hut_raged",
			() -> new BattleBuilderHutRagedItem());
	public static final RegistryObject<Item> MORTAR_LV_14_RAGED = REGISTRY.register("mortar_lv_14_raged", () -> new MortarLv14RagedItem());
	...
	public static final RegistryObject<Item> FF = REGISTRY.register("ff", () -> new FFItem());
	public static final RegistryObject<Item> TOWN_HALL_12_RW = REGISTRY.register("town_hall_12_rw", () -> new TownHall12RWItem());
	public static final RegistryObject<Item> PEKKA_ARMOR_HELMET = REGISTRY.register("pekka_armor_helmet", () -> new PekkaArmorItem.Helmet());
	public static final RegistryObject<Item> PEKKA_ARMOR_CHESTPLATE = REGISTRY.register("pekka_armor_chestplate",
			() -> new PekkaArmorItem.Chestplate());
	public static final RegistryObject<Item> PEKKA_ARMOR_LEGGINGS = REGISTRY.register("pekka_armor_leggings", () -> new PekkaArmorItem.Leggings());
	public static final RegistryObject<Item> PEKKA_ARMOR_BOOTS = REGISTRY.register("pekka_armor_boots", () -> new PekkaArmorItem.Boots());
	public static final RegistryObject<Item> XBOW_LV_TWONI = REGISTRY.register("xbow_lv_twoni_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.XBOW_LV_TWONI, -16777216, -3355648,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> D_CANNON = REGISTRY.register("d_cannon_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.D_CANNON, -6710887, -10079488,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> MULTI_CANNON = REGISTRY.register("multi_cannon_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.MULTI_CANNON, -65485, -6724096,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> ROCKET_R = REGISTRY.register("rocket_r", () -> new RocketRItem());
	public static final RegistryObject<Item> ROCKET_ARTILERY = REGISTRY.register("rocket_artilery_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.ROCKET_ARTILERY, -6710887, -65536,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> MOUNTAIN_GOLEM = REGISTRY.register("mountain_golem_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.MOUNTAIN_GOLEM, -6710887, -10027264,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> BATTLE_BUILDER = REGISTRY.register("battle_builder_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.BATTLE_BUILDER, -6724096, -10066330,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> CC_1 = REGISTRY.register("cc_1", () -> new CC1Item());
	public static final RegistryObject<Item> MEGATROOP = REGISTRY.register("megatroop_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.MEGATROOP, -65536, -6724096,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> GIANT_BALLS = REGISTRY.register("giant_balls", () -> new GiantBallsItem());
	public static final RegistryObject<Item> GIANT_CANNON_BB = REGISTRY.register("giant_cannon_bb_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.GIANT_CANNON_BB, -10066330, -13421773,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> AIR_BBB = REGISTRY.register("air_bbb_spawn_egg",
			() -> new ForgeSpawnEggItem(ClashofclansweaponsModEntities.AIR_BBB, -6724096, -16777012,
					new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> CLAN_CAPITAL_HEAL_SPELL = REGISTRY.register("clan_capital_heal_spell",
			() -> new ClanCapitalHealSpellItem());
	public static final RegistryObject<Item> XBOW_2_OGGETTO = REGISTRY.register("xbow_2_oggetto", () -> new Xbow2OggettoItem());
	public static final RegistryObject<Item> DOUBLR_CANNON_LV_1_I = REGISTRY.register("doublr_cannon_lv_1_i", () -> new DoublrCannonLv1IItem());
	public static final RegistryObject<Item> MULTI_CANNON_P = REGISTRY.register("multi_cannon_p", () -> new MultiCannonPItem());
	public static final RegistryObject<Item> RLB = REGISTRY.register("rlb", () -> new RlbItem());
	public static final RegistryObject<Item> AIR_BOMBS_E = REGISTRY.register("air_bombs_e", () -> new AirBombsEItem());
	public static final RegistryObject<Item> CLAN_CAPITAL_FROST_SPELL = REGISTRY.register("clan_capital_frost_spell",
			() -> new ClanCapitalFrostSpellItem());
	public static final RegistryObject<Item> CLAN_CAPITAL_RAGE_SPELL = REGISTRY.register("clan_capital_rage_spell",
			() -> new ClanCapitalRageSpellItem());
	...
	public static final RegistryObject<Item> RAGE_SPELL_FACTORY_BLOCK = block(ClashofclansweaponsModBlocks.RAGE_SPELL_FACTORY_BLOCK,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
	public static final RegistryObject<Item> FROST_SPELL_FACTORY_BUILDING = block(ClashofclansweaponsModBlocks.FROST_SPELL_FACTORY_BUILDING,
			ClashofclansweaponsModTabs.TAB_BUILDINGS);
