...
public class GiantItemItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		GiantItemRightClickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
