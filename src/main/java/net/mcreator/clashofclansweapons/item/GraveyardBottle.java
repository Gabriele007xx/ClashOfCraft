...
public class GraveyardBottle extends Item {
    public GraveyardBottle() {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        {
            Entity entity =  new GraveyardBEntity(ClashofclansweaponsModEntities.GRAVEYARD_B.get(), context.getLevel());
