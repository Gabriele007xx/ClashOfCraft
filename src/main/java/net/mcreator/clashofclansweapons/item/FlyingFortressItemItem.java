...
public class FlyingFortressItemItem extends Item{
    public FlyingFortressItemItem() {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        {
            MegatroopEntity entity = new MegatroopEntity(ClashofclansweaponsModEntities.MEGATROOP.get(), context.getLevel());
