...
import net.mcreator.clashofclansweapons.procedures.RlbRightclickedOnBlockProcedure;
import net.mcreator.clashofclansweapons.init.ClashofclansweaponsModTabs;

public class RlbItem extends Item {
	public RlbItem() {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		RlbRightclickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
