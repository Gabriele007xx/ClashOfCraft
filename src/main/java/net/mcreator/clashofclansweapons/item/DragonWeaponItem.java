...
public class DragonWeaponItem extends Item {
	public DragonWeaponItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				DragonWeaponEntity entityarrow = DragonWeaponEntity.shoot(world, entity, world.getRandom(), 1f, 7, 0);
