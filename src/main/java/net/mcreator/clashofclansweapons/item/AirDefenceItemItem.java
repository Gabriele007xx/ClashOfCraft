...
public class AirDefenceItemItem extends Item {
	public AirDefenceItemItem() {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		AirDefenceItemRightClickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
