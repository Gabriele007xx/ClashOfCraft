...
public class DragonItemItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		DragonItemRightClickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
