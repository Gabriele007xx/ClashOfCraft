...
public class TownHall12RWItem extends Item {
	public TownHall12RWItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				TownHall12RWEntity entityarrow = TownHall12RWEntity.shoot(world, entity, world.getRandom(), 1f, 2, 0);
