...
public class Modelmulticannonlvone<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("clashofclansweapons", "modelmulticannonlvone"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(20, 22).addBox(-5.0F, -13.0F, -6.0F, 5.0F, 5.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(0, 17)
