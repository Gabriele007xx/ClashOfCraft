...
public class Modelgiantlv1new<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("clashofclansweapons", "modelgiantlv_1new"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition waist = partdefinition.addOrReplaceChild("waist", CubeListBuilder.create(), PartPose.offset(8.0F, -12.0F, 0.0F));
		PartDefinition body = waist.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(48, 48).addBox(-20.0F, -24.0F, -2.0F, 24.0F, 36.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -12.0F, 0.0F));
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-20.0F, -48.0F, -4.0F, 24.0F, 24.0F, 24.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rightArm = body.addOrReplaceChild("rightArm",
				CubeListBuilder.create().texOffs(120, 48).addBox(-27.0F, -26.0F, -2.0F, 12.0F, 36.0F, 12.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leftArm = body.addOrReplaceChild(
				"leftArm", CubeListBuilder.create().texOffs(120, 48).mirror()
		...
		PartDefinition rightLeg = body.addOrReplaceChild("rightLeg",
				CubeListBuilder.create().texOffs(0, 48).addBox(-18.0F, 0.0F, -2.0F, 12.0F, 36.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 12.0F, 0.0F));
		PartDefinition leftLeg = body.addOrReplaceChild(
				"leftLeg", CubeListBuilder.create().texOffs(0, 48).mirror()
