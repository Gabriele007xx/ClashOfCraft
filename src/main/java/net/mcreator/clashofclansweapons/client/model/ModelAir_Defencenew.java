...
public class ModelAir_Defencenew<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("clashofclansweapons", "model_air_defencenew"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(30, 52).addBox(-8.0F, -1.0F, -8.0F, 16.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 40)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, -6.0F, 6.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -6.0F, -7.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
