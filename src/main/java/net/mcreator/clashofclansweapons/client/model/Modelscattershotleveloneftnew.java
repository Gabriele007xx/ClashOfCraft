...
public class Modelscattershotleveloneftnew<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("clashofclansweapons", "modelscattershotleveloneftnew"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 50).addBox(-18.0F, -4.0F, -17.0F, 36.0F, 2.0F, 36.0F, new CubeDeformation(0.0F)).texOffs(28, 118)
