...
public class ModelTownHall12<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("clashofclansweapons", "model_town_hall_12"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(225, 242).addBox(-45.0F, -8.0F, -39.0F, 5.0F, 8.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(38, 73)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(248, 0).addBox(67.0F, -59.0F, 17.0F, 10.0F, 5.0F, 41.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 0.0F, -31.0F, 0.0F, 0.0F, -0.7854F));
		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(269, 136).addBox(-80.0F, -58.0F, 17.0F, 10.0F, 5.0F, 41.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 0.0F, -31.0F, 0.0F, 0.0F, 0.7854F));
