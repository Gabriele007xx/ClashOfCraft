...
public class Modelmortarlv1<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("clashofclansweapons", "modelmortarlv_1"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 109).addBox(-8.0F, -5.0F, -7.0F, 2.0F, 5.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(100, 114)
