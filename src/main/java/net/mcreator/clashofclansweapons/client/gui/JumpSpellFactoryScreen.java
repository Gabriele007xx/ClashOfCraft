...
public class JumpSpellFactoryScreen extends AbstractContainerScreen<JumpSpellFactoryMenu> {
	private final static HashMap<String, Object> guistate = JumpSpellFactoryMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public JumpSpellFactoryScreen(JumpSpellFactoryMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/jump_spell_factory.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Jump Spell Factory", 6, 7, -12829636);
