...
public class BBElixirCollector1GUIScreen extends AbstractContainerScreen<BBElixirCollector1GUIMenu> {
	private final static HashMap<String, Object> guistate = BBElixirCollector1GUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public BBElixirCollector1GUIScreen(BBElixirCollector1GUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/bb_elixir_collector_1_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "capacity")) + "", 6, 25, -12829636);
		this.font.draw(poseStack, "Production: 1 elixir/sec", 6, 52, -12829636);
	}
