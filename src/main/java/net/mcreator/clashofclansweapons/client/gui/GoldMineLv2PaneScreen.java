...
public class GoldMineLv2PaneScreen extends AbstractContainerScreen<GoldMineLv2PaneMenu> {
	private final static HashMap<String, Object> guistate = GoldMineLv2PaneMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public GoldMineLv2PaneScreen(GoldMineLv2PaneMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/gold_mine_lv_2_pane.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Gold Mine (Liv.2)", 42, 7, -12829636);
		this.font.draw(poseStack, "Production:0.15 gold/sec", 6, 52, -256);
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "capacity")) + "", 6, 25, -256);
	}
