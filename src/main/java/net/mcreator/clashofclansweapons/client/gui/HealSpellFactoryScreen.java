...
public class HealSpellFactoryScreen extends AbstractContainerScreen<HealSpellFactoryMenu> {
	private final static HashMap<String, Object> guistate = HealSpellFactoryMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public HealSpellFactoryScreen(HealSpellFactoryMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/heal_spell_factory.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Heal Spell Factory", 6, 7, -12829636);
