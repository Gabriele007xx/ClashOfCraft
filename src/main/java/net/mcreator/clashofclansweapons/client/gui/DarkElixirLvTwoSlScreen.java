...
public class DarkElixirLvTwoSlScreen extends AbstractContainerScreen<DarkElixirLvTwoSlMenu> {
	private final static HashMap<String, Object> guistate = DarkElixirLvTwoSlMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public DarkElixirLvTwoSlScreen(DarkElixirLvTwoSlMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/dark_elixir_lv_two_sl.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Dark Elixir Drill (Liv.2)", 33, 11, -12829636);
		this.font.draw(poseStack, "Production: 0.15 dark elixir/sec", 6, 83, -12829636);
