...
public class ElixirCollectorLevel5GUIScreen extends AbstractContainerScreen<ElixirCollectorLevel5GUIMenu> {
	private final static HashMap<String, Object> guistate = ElixirCollectorLevel5GUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ElixirCollectorLevel5GUIScreen(ElixirCollectorLevel5GUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/elixir_collector_level_5_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Elixir Collector (Liv.5)", 24, 7, -12829636);
		this.font.draw(poseStack, "Production:1 elixir/sec", 6, 52, -3407668);
