...
public class ElixirCollectorLevel2GUIScreen extends AbstractContainerScreen<ElixirCollectorLevel2GUIMenu> {
	private final static HashMap<String, Object> guistate = ElixirCollectorLevel2GUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ElixirCollectorLevel2GUIScreen(ElixirCollectorLevel2GUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/elixir_collector_level_2_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Elixir Collector (Liv.2)", 24, 7, -12829636);
		this.font.draw(poseStack, "Production:0.5 elixir/sec", 6, 52, -3407668);
