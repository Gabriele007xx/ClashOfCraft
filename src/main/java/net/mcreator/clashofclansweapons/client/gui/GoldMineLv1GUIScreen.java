...
public class GoldMineLv1GUIScreen extends AbstractContainerScreen<GoldMineLv1GUIMenu> {
	private final static HashMap<String, Object> guistate = GoldMineLv1GUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public GoldMineLv1GUIScreen(GoldMineLv1GUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/gold_mine_lv_1_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Gold Mine (Liv.1)", 42, 7, -12829636);
		this.font.draw(poseStack, "Production:0.1 gold/sec", 6, 52, -256);
