...
public class ElixirUpGUIScreen extends AbstractContainerScreen<ElixirUpGUIMenu> {
	private final static HashMap<String, Object> guistate = ElixirUpGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ElixirUpGUIScreen(ElixirUpGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/elixir_up_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Elixir Collector Upgrader", 40, 11, -12829636);
