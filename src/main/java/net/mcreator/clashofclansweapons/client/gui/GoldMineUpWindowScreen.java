...
public class GoldMineUpWindowScreen extends AbstractContainerScreen<GoldMineUpWindowMenu> {
	private final static HashMap<String, Object> guistate = GoldMineUpWindowMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public GoldMineUpWindowScreen(GoldMineUpWindowMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/gold_mine_up_window.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Gold Mine Upgrader", 67, 11, -12829636);
