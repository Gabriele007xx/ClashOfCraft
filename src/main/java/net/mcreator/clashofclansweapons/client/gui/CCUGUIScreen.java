...
public class CCUGUIScreen extends AbstractContainerScreen<CCUGUIMenu> {
	private final static HashMap<String, Object> guistate = CCUGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public CCUGUIScreen(CCUGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/ccugui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Clan Castle Upgrader", 40, 11, -12829636);
