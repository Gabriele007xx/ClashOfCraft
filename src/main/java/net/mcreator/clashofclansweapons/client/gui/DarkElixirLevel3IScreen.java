...
public class DarkElixirLevel3IScreen extends AbstractContainerScreen<DarkElixirLevel3IMenu> {
	private final static HashMap<String, Object> guistate = DarkElixirLevel3IMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public DarkElixirLevel3IScreen(DarkElixirLevel3IMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/dark_elixir_level_3_i.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Dark Elixir Drill (Liv.3)", 33, 11, -12829636);
		this.font.draw(poseStack, "Production: 0.2 dark elixir/sec", 6, 83, -12829636);
