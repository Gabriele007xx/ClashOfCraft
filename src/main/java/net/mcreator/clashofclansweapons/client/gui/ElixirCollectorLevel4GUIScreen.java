...
public class ElixirCollectorLevel4GUIScreen extends AbstractContainerScreen<ElixirCollectorLevel4GUIMenu> {
	private final static HashMap<String, Object> guistate = ElixirCollectorLevel4GUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ElixirCollectorLevel4GUIScreen(ElixirCollectorLevel4GUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/elixir_collector_level_4_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Elixir Collector (Liv.4)", 24, 7, -12829636);
		this.font.draw(poseStack, "Production:0.8 elixir/sec", 6, 52, -3407668);
