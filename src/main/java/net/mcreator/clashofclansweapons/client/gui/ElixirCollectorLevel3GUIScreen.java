...
public class ElixirCollectorLevel3GUIScreen extends AbstractContainerScreen<ElixirCollectorLevel3GUIMenu> {
	private final static HashMap<String, Object> guistate = ElixirCollectorLevel3GUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ElixirCollectorLevel3GUIScreen(ElixirCollectorLevel3GUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/elixir_collector_level_3_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Elixir Collector (Liv.3)", 24, 7, -12829636);
		this.font.draw(poseStack, "Production:0.6 elixir/sec", 6, 52, -3407668);
