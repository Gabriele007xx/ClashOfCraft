...
public class TownHallUpgradeUIScreen extends AbstractContainerScreen<TownHallUpgradeUIMenu> {
	private final static HashMap<String, Object> guistate = TownHallUpgradeUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public TownHallUpgradeUIScreen(TownHallUpgradeUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/town_hall_upgrade_ui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Town Hall Upgrader", 67, 11, -12829636);
