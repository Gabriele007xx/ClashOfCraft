...
public class FrostSpellFactoryScreen extends AbstractContainerScreen<FrostSpellFactoryMenu> {
	private final static HashMap<String, Object> guistate = FrostSpellFactoryMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public FrostSpellFactoryScreen(FrostSpellFactoryMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("clashofclansweapons:textures/screens/frost_spell_factory.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Frost Spell Factory", 6, 7, -12829636);
