...
public class BigBoyEntity extends Troop {
	public BigBoyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClashofclansweaponsModEntities.BIG_BOY.get(), world);
	}

	public BigBoyEntity(EntityType<BigBoyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
