...
public class ValkiryeEntity extends Troop {
	public ValkiryeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClashofclansweaponsModEntities.VALKIRYE.get(), world);
	}

	public ValkiryeEntity(EntityType<ValkiryeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
