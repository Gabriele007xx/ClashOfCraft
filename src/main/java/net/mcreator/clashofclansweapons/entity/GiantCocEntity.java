...
public class GiantCocEntity extends Troop {
	public GiantCocEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClashofclansweaponsModEntities.GIANT_COC.get(), world);
	}

	public GiantCocEntity(EntityType<GiantCocEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
