...
public class WitchSkeletonEntity extends Troop {
	public WitchSkeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClashofclansweaponsModEntities.WITCH_SKELETON.get(), world);
	}

	public WitchSkeletonEntity(EntityType<WitchSkeletonEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ClashofclansweaponsModItems.BARBARIAN_SWORD_LV_3.get()));
	}
