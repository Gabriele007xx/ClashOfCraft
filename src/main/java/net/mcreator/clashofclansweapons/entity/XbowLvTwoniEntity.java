...
import net.mcreator.clashofclansweapons.procedures.CheckIf2019Procedure;
...
public class XbowLvTwoniEntity extends Defense implements RangedAttackMob {
	public XbowLvTwoniEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClashofclansweaponsModEntities.XBOW_LV_TWONI.get(), world);
	}

	public XbowLvTwoniEntity(EntityType<XbowLvTwoniEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Xbow (Lv.2)"));
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("Xbow Lv Twoni");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(XbowLvTwoniEntity.this.getId());
