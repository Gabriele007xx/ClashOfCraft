...
public class DarkElxir7GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DarkElxir7GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ClashofclansweaponsModMenus.DARK_ELXIR_7_GUI, id);
