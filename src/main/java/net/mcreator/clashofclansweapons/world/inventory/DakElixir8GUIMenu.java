...
public class DakElixir8GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DakElixir8GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ClashofclansweaponsModMenus.DAK_ELIXIR_8_GUI, id);
