...
public class DarkElixir9GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DarkElixir9GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ClashofclansweaponsModMenus.DARK_ELIXIR_9_GUI, id);
		...
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 16, 53) {
		}));
