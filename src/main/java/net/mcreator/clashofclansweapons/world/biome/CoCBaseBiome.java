...
public class CoCBaseBiome {
	public static final Climate.ParameterPoint PARAMETER_POINT = new Climate.ParameterPoint(Climate.Parameter.span(-0.142857142857f, 0.142857142857f),
			...
			Climate.Parameter.span(-0.1156443676f, 0.170069918114f), 0);

	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(12638463).waterColor(-16724788).waterFogColor(329011)
				.skyColor(7972607).foliageColorOverride(-13369549).grassColorOverride(-13369549).build();
		BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder();
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("clashofclansweapons:tree_co_c_base",
				FeatureUtils.register("clashofclansweapons:tree_co_c_base", Feature.TREE,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils
				.register("clashofclansweapons:seagrass_co_c_base", AquaticFeatures.SEAGRASS_SHORT, AquaticPlacements.seagrassPlacement(5)));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("clashofclansweapons:disk_sand_co_c_base",
						FeatureUtils.register("clashofclansweapons:disk_sand_co_c_base", Feature.DISK,
								new DiskConfiguration(Blocks.SAND.defaultBlockState(), UniformInt.of(2, 6), 2,
										List.of(ClashofclansweaponsModBlocks.COC_GRASS.get().defaultBlockState(), Blocks.DIRT.defaultBlockState()))),
