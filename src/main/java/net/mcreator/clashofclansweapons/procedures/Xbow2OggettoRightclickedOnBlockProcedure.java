...
public class Xbow2OggettoRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, ItemStack itemstack) {
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = new XbowLvTwoniEntity(ClashofclansweaponsModEntities.XBOW_LV_TWONI.get(), _level);
