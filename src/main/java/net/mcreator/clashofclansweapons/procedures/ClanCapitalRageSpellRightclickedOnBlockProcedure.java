...
public class ClanCapitalRageSpellRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, ItemStack itemstack) {
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = new CCIncantesimo2Entity(ClashofclansweaponsModEntities.CC_INCANTESIMO_2.get(), _level);
