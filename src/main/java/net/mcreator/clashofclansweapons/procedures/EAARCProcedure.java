...
public class EAARCProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (!(entity instanceof Player _plr ? _plr.getAbilities().instabuild : false)) {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new EagleArtilleryEntity(ClashofclansweaponsModEntities.EAGLE_ARTILLERY.get(), _level);
			...
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(ClashofclansweaponsModItems.EAGLE_ARTILLERY_ITEM.get());
