...
public class ClanCapitalJumpSpellRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, ItemStack itemstack) {
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = new JumpEntityEntity(ClashofclansweaponsModEntities.JUMP_ENTITY.get(), _level);
