...
public class MultiCannonPRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, ItemStack itemstack) {
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = new MultiCannonEntity(ClashofclansweaponsModEntities.MULTI_CANNON.get(), _level);
