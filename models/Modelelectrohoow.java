...
public static class Modelelectrohoow extends EntityModel<Entity> {
	...
	public Modelelectrohoow() {
		...
		rightEar_r1.setRotationPoint(0.0F, 24.0F, 0.0F);
		rightEar.addChild(rightEar_r1);
		setRotationAngle(rightEar_r1, 0.0F, 0.0F, -1.0036F);
		rightEar_r1.setTextureOffset(58, 55).addBox(20.0F, -23.0F, -4.0F, 2.0F, 8.0F, 1.0F, 0.0F, false);
		...
		leftEar_r1.setRotationPoint(0.0F, 24.0F, 0.0F);
		leftEar.addChild(leftEar_r1);
		setRotationAngle(leftEar_r1, 0.0F, 0.0F, 1.0036F);
		leftEar_r1.setTextureOffset(58, 55).addBox(-22.0F, -23.0F, -4.0F, 2.0F, 8.0F, 1.0F, 0.0F, true);
