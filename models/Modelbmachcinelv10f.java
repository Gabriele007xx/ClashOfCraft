...
public static class Modelbmachcinelv10f extends EntityModel<Entity> {
	...
	public Modelbmachcinelv10f() {
		...
		rightarm.setTextureOffset(8, 44).addBox(-16.0F, -23.0F, -15.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		...
		bb_main.setTextureOffset(34, 9).addBox(-14.0F, -23.0F, -1.0F, 6.0F, 2.0F, 1.0F, 0.0F, false);
		bb_main.setTextureOffset(39, 13).addBox(9.0F, -23.0F, -1.0F, 6.0F, 2.0F, 1.0F, 0.0F, false);
		bb_main.setTextureOffset(26, 1).addBox(-8.0F, -23.0F, -2.0F, 17.0F, 1.0F, 3.0F, 0.0F, false);
		bb_main.setTextureOffset(0, 105).addBox(-9.0F, -24.0F, -9.0F, 19.0F, 1.0F, 17.0F, 0.0F, false);
		bb_main.setTextureOffset(0, 105).addBox(-9.0F, -46.0F, 7.0F, 19.0F, 22.0F, 1.0F, 0.0F, false);
		bb_main.setTextureOffset(0, 110).addBox(-9.0F, -41.0F, -9.0F, 19.0F, 17.0F, 1.0F, 0.0F, false);
		bb_main.setTextureOffset(96, 96).addBox(-9.0F, -41.0F, -8.0F, 1.0F, 17.0F, 15.0F, 0.0F, false);
		bb_main.setTextureOffset(96, 96).addBox(9.0F, -41.0F, -8.0F, 1.0F, 17.0F, 15.0F, 0.0F, false);
		bb_main.setTextureOffset(9, 41).addBox(9.0F, -45.0F, -1.0F, 1.0F, 4.0F, 8.0F, 0.0F, false);
		bb_main.setTextureOffset(12, 41).addBox(-9.0F, -45.0F, -1.0F, 1.0F, 4.0F, 8.0F, 0.0F, false);
		bb_main.setTextureOffset(92, 0).addBox(-8.0F, -44.0F, 6.0F, 17.0F, 20.0F, 1.0F, 0.0F, false);
		bb_main.setTextureOffset(78, 12).addBox(-8.0F, -25.0F, -1.0F, 17.0F, 1.0F, 7.0F, 0.0F, false);
		bb_main.setTextureOffset(34, 44).addBox(-20.0F, -47.0F, -2.0F, 9.0F, 1.0F, 5.0F, 0.0F, false);
		bb_main.setTextureOffset(39, 48).addBox(-20.0F, -46.0F, 2.0F, 9.0F, 5.0F, 1.0F, 0.0F, false);
		bb_main.setTextureOffset(32, 41).addBox(-20.0F, -46.0F, -2.0F, 9.0F, 5.0F, 1.0F, 0.0F, false);
		bb_main.setTextureOffset(35, 40).addBox(-19.0F, -24.0F, -13.0F, 1.0F, 3.0F, 3.0F, 0.0F, false);
		bb_main.setTextureOffset(35, 40).addBox(-13.0F, -24.0F, -13.0F, 1.0F, 3.0F, 3.0F, 0.0F, false);
		bb_main.setTextureOffset(35, 40).addBox(-19.0F, -24.0F, -14.0F, 7.0F, 3.0F, 1.0F, 0.0F, false);
		bb_main.setTextureOffset(35, 40).addBox(-19.0F, -24.0F, -10.0F, 7.0F, 3.0F, 1.0F, 0.0F, false);
	}
