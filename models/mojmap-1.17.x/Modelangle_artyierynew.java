...
public class Modelangle_artyierynew<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "angle_artyierynew"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-24.0F, -8.0F, -8.0F, 32.0F, 8.0F, 32.0F, new CubeDeformation(0.0F)).texOffs(12, 49)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(41, 5)
						.addBox(-5.0F, -22.0F, 15.0F, 2.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(48, 5)
						.addBox(-5.0F, -17.0F, 15.0F, 2.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(46, 6)
						.addBox(-5.0F, -12.0F, 15.0F, 2.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.3491F, 0.0F));

		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(40, 12)
						.addBox(-10.0F, -22.0F, -14.0F, 4.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(40, 8)
						.addBox(-10.0F, -17.0F, -14.0F, 4.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(42, 6)
						.addBox(-8.0F, -12.0F, -14.0F, 2.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.3491F, 0.0F));
