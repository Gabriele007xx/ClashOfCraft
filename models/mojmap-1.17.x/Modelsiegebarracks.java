...
public class Modelsiegebarracks<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "siegebarracks"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-24.0F, -49.0F, -26.0F, 48.0F, 48.0F, 48.0F, new CubeDeformation(0.0F)).texOffs(0, 148)
		...
		PartDefinition cube_r1 = bb_main
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(0, 96).addBox(-16.0F, -28.0F, 27.0F, 32.0F, 2.0F, 32.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, -15.0F, -0.48F, 0.0F, 0.0F));

		PartDefinition cube_r2 = bb_main
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(96, 98).addBox(-16.0F, -16.0F, -36.0F, 32.0F, 2.0F, 32.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, -15.0F, 0.48F, 0.0F, 0.0F));

		PartDefinition cube_r3 = bb_main
				.addOrReplaceChild("cube_r3",
						CubeListBuilder.create().texOffs(0, 130).addBox(16.0F, -21.0F, -3.0F, 32.0F, 2.0F, 32.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, -15.0F, 0.0F, 0.0F, 0.48F));

		PartDefinition cube_r4 = bb_main
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(96, 132).addBox(-47.0F, -21.0F, -3.0F, 32.0F, 2.0F, 32.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, -15.0F, 0.0F, 0.0F, -0.48F));
