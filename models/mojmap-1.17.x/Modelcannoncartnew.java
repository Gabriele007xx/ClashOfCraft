...
public class Modelcannoncartnew<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cannoncartnew"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0)
						...
						.addBox(-10.0F, -3.0F, -9.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(48, 45)
						.addBox(-12.0F, -4.0F, -8.0F, 24.0F, 3.0F, 16.0F, new CubeDeformation(0.0F)),
