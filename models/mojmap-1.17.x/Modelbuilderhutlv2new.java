...
public class Modelbuilderhutlv2new<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "builderhutlv2new"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 11)
						.addBox(-4.0F, -11.0F, 1.0F, 1.0F, 11.0F, 19.0F, new CubeDeformation(0.0F)).texOffs(0, 11)
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 5)
						.addBox(-19.0F, -46.0F, 3.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(9, 74)
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(27, 20)
						.addBox(-4.0F, -13.0F, -10.0F, 3.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 128)
