...
public class Modelgiant_armor_petto<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "giant_armor_petto"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(40, 16)
						.addBox(-3.0F, -4.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(1.0F)).texOffs(48, 17)
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(40, 16).mirror()
						.addBox(-1.0F, -4.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(1.0F)).mirror(false)
						.texOffs(48, 17).addBox(3.0F, -7.0F, 1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(47, 16).addBox(3.0F, -7.0F, -2.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));
