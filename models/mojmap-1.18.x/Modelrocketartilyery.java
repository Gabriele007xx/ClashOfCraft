...
public class Modelrocketartilyery<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "rocketartilyery"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-16.0F, -1.0F, -16.0F, 32.0F, 1.0F, 32.0F, new CubeDeformation(0.0F)).texOffs(0, 33)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.0F, -31.0F, -15.0F, 2.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(58, 66)
						...
						.addBox(-8.0F, -24.0F, -23.0F, 13.0F, 11.0F, 23.0F, new CubeDeformation(0.0F)).texOffs(0, 66)
						.addBox(-8.0F, -13.0F, -24.0F, 13.0F, 5.0F, 32.0F, new CubeDeformation(0.0F)),
