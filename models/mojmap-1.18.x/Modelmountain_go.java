...
public class Modelmountain_go<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mountain_go"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(301, 258)
				.addBox(-39.0F, -4.0F, -14.0F, 18.0F, 4.0F, 26.0F, new CubeDeformation(0.0F)).texOffs(0, 171)
				.addBox(-26.0F, -4.0F, -22.0F, 5.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(116, 159)
